...
%changelog
* Wed Apr 04 2012 Jiri Benc <jbenc@redhat.com> 1.0.10 1
- updated to new driver version

* Fri Jan 27 2012 Jiri Benc <jbenc@redhat.com> 1.0.8 2
- synced with 6.2 GA

* Tue Nov 01 2011 Jiri Benc <jbenc@redhat.com> 1.0.8 1
- updated to new driver version

* Fri Oct 21 2011 Jiri Olsa <jolsa@redhat.com> 1.0.6 4
- new spec version

* Fri Sep 30 2011 Jiri Olsa <jolsa@redhat.com> 1.0.6 3
- new spec version

* Thu Sep 22 2011 Jiri Benc <jbenc@redhat.com> 1.0.6 2
- build fix

* Wed Sep 21 2011 Jiri Benc <jbenc@redhat.com> 1.0.6 1
- updated to new driver version

* Fri Aug 19 2011 Jiri Olsa <jolsa@redhat.com> 1.0.4 3
- zstream build changes

* Tue Aug 16 2011 Jiri Olsa <jolsa@redhat.com> 1.0.4 1
- bnx2fc DUP module
